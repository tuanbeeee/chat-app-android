...
import com.example.chatproject.fragments.AdminFragment;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (user.getRole().equals("user")){
                    viewPagerAdapter.addFragment(new AdminFragment(), "List Admin");
                    viewPagerAdapter.addFragment(new ChatsFragment(), "Chat");
                }
                else if (user.getRole().equals("admin")){
                    viewPagerAdapter.addFragment(new UsersFragment(), "List User");
                    viewPagerAdapter.addFragment(new ChatsFragment(), "Chat");
